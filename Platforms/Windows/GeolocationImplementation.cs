...
using WindowsGeolocation = Windows.Devices.Geolocation;
...
public class GeolocatorImplementation : IGeolocator
{
    ...
    private void OnLocatorPositionChanged(Geolocator sender, WindowsGeolocation.PositionChangedEventArgs e)
    {
    ...
    private static Position GetPosition(Geoposition position)
    {
        ...
        pos.HasAltitude = position.Coordinate.Point.AltitudeReferenceSystem != WindowsGeolocation.AltitudeReferenceSystem.Unspecified;
